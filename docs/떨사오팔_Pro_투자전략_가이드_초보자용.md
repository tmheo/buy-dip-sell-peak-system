...
|------|----------|--------|---------------|------|
| **Pro1** | $13,429 | 34.29% | -18.9% | MDD가 가장 낮음 |
| **Pro2** | $15,292 | 52.92% | -27.7% | 수익률 최고 |
| **Pro3** | $13,304 | 33.04% | -47.6% | MDD가 가장 큼 |

※ 배당·분할이 조정된 수정 종가(adjClose) 기준 백테스트 결과입니다.
...
- 개별 전략 대비 **더 높은 수익률** (79.51% vs 33~53%)
  ※ 추천 전략 수치는 실제 종가(close) 기준의 이전 백테스트 결과라 개별 전략 표(adjClose 기준)와 가격 기준이 다릅니다. 추천 백테스트가 수정 종가로 이행되면 함께 갱신됩니다.
