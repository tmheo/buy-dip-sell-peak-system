...
- [ ] AC-001: Info 페이지 모든 섹션 렌더링
- [ ] AC-002: Backtest 폼 모든 필드 작동
- [ ] AC-003: 1700px, 768px 브레이크포인트 동작
- [ ] AC-004: 색상 팔레트 일치 (배경, 강조, 가격)
- [ ] AC-005: 라우팅 정상 작동 (/, /info, /backtest)
- [ ] AC-006: 메뉴 활성화 상태 표시
- [ ] AC-007: 전략 카드 3열/1열 레이아웃
- [ ] AC-008: 플로우차트 5단계 + 화살표
- [ ] AC-009: 폼 기본값 설정
- [ ] AC-010: 로딩 스피너 동작
